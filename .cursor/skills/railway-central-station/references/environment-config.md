...
{
  "services": {
    "<serviceId>": { "deploy": { "multiRegionConfig": { "us-west2": { "numReplicas": 3 } } } }
  }
}
```
...
{
  "services": {
    "<serviceId>": { "deploy": { "healthcheckPath": "/health", "healthcheckTimeout": 30 } }
  }
}
```
...
{
  "services": {
    "<serviceId>": { "build": { "builder": "DOCKERFILE", "dockerfilePath": "./Dockerfile" } }
  }
}
```
