...
describe('AdminService', () => {
  ...
  describe('getUsers', () => {
    it('should return paginated users with default filters', async () => {
      const mockUsers = [
        { id: 'user-1', firstName: 'John', lastName: 'Doe', emails: [{ email: 'john@example.com', primary: true }] },
        { id: 'user-2', firstName: 'Jane', lastName: 'Smith', emails: [{ email: 'jane@example.com', primary: true }] },
      ]
